...
namespace BlazorMovies.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //OData Service -> Uso convencional
            /*
            ...
            */
            services.AddOData();//Adicionando Odata sem parametro e colocalndo nos endpoints com injecao de dependencia
           ...
           // app.UseAuthorization();
            ...
            app.UseEndpoints(endpoints =>
            {
               ...
               // endpoints.MapFallbackToFile("/App/{*path:nonfile}", "App/index.html");
                endpoints.EnableDependencyInjection(); //Habilitando OData nas rotas padroes ja definidas
                endpoints.Expand().Select().Filter().OrderBy().Count().MaxTop(10);//Operacoes Liberadas pelo OData
            });
        }
    }
}
